...
const PUBLISHED_PILLS = [
  ...
  { slug: "colaborativa-42", lang: "es", type: "collaborative", title: "De la apertura por experiencia al sistema histórico de tiendas y mantenimiento", author: "Rubén Vicent", authorEmail: "", avatar: "/assets/profile/ruben-vicent-360.jpg", publishedAt: "2026-04-29T16:30:00Z", urlPath: "/projects/colaborativa-42/es/" },
];
const COLLABORATIVE_PILLS = PUBLISHED_PILLS.filter((item) => item.type === "collaborative");
const DEMO_EXECUTIVE_SLUG_ORDER = [
  "pildora-5",
  "pildora-6",
  ...Array.from({ length: 42 }, (_, idx) => `colaborativa-${idx + 1}`),
];
  ...
  async getDemoActivityHubData(hubBaseUrl) {
    ...
    return {
      summary: {
        ...
        totalLoginCount: Number(accessDashboard?.summary?.loginCount || 0),
      },
